...
impl Application{
    ...
    pub async fn build(configuration: Settings) -> Result<Self, anyhow::Error> {
        ...
        let server = run(listener, connection_pool,configuration.application.hmac_secret, configuration.redis_uri).await?;
...
pub async fn run(listener: TcpListener, db_pool: PgPool, hmac_secret: Secret<String>, redis_uri: Secret<String>) -> Result<Server, anyhow::Error> {
